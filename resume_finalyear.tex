...
\begin{itemize}[leftmargin=0.07cm]
\item[] {\large Most Violated Constraint for Concentrated ROC (CROC)}\hspace*{\fill}\makebox[3.5cm][l]{\emph{(Jan'16 - Ongoing)}}\\
...
\begin{itemize}[leftmargin=0.07cm]
\newpage
\item[] {\large Convex Surrogates for Optimising AUC related performance measures}\hspace*{\fill}\makebox[3.5cm][l]{\emph{(Jul'16 - Ongoing)}}\\
\emph{Mentor: Prof. Purushottam Kar, Department of Computer Science and Engineering, IIT Kanpur
}	\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\item[] {\large Object Detection and Classification in Traffic Surveillance Video}\hspace*{\fill}\makebox[5.7cm][l]{\emph{Course Project (Jan'16 - Apr'16)}}\\
