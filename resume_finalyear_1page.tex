...
\end{flushleft}
\vspace{-0.2cm}
{\small Final Year Undergraduate\hspace*{\fill}\makebox[4.5cm][l]{Ph: +91-7388447711}\newline
...
\hline
Year         & Degree & Institution & GPA/Percentage\\ \hline
...
\item[] {\large Convex Surrogates for Optimising AUC related performance measures}\hspace*{\fill}\makebox[3.4cm][l]{\emph{(Jul'16 - Ongoing)}}\\
\emph{Mentor: Prof. Purushottam Kar, Department of Computer Science and Engineering, IIT Kanpur
}	\begin{itemize}
